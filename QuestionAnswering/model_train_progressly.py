...
def train_portion(ace_ontology, data_ace, ratio):
    ...
    # developping set
    dev_set = build_examples(ace_ontology, data_ace['val'], training=False)
...
if __name__ == '__main__':
    ...
    pickle.dump(temp, open('../data_progress.pickle', 'wb'))
    

    ace_ontology, data_ace = pickle.load(open('../data_progress.pickle', 'rb'))
