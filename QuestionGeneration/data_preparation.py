import sys
sys.path.insert(1, '../QuestionAnswering')
import json
from util import transfer_data_format
...
def generate_context(flag):
    ...
    with open('../QuestionAnswering/data', 'r') as f:
    ...
    for elem in data_ace[flag]:
        print(elem[2])  #List of words from current example
        words = elem[2]
        trigger_span = elem[4]     #Word indeces of event trigger text
...
def generate_question():
    ...
    // ------ Looks like this following section is to generate MORE questions in addition to those from SQuAD
...
if __name__ == '__main__':
    fin = open('../QuestionAnswering/src_context.txt', 'w')
    ...
    fin = open('../QuestionAnswering/tgt_question.txt', 'w')
